...
/* package fawk-0.1.0.0 */
#ifndef VERSION_fawk
#define VERSION_fawk "0.1.0.0"
#endif /* VERSION_fawk */
#ifndef MIN_VERSION_fawk
#define MIN_VERSION_fawk(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_fawk */
...
#define CURRENT_COMPONENT_ID "fawk-0.1.0.0-inplace-fawk"
